...
module.exports = {
    ...
    start: async(naisa, m, { text }) => {
        if (text.toLowerCase() === "random") {
            ...
            //naisa.sendFile(m.from, fetch.result.img, "", m, { caption }) yg gambarnya kena internet positif
            ...
            //naisa.sendFile(m.from, fetch.result[0].img, "", m, { caption }) yg gambarnya kena internet positif
            naisa.sendText(m.from, caption, m)
        } else {
